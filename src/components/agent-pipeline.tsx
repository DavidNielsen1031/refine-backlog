      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-14">
          ...
          <ScrollReveal delay={1}>
            <div className="rounded-xl border border-rose-900/50 bg-rose-950/10 p-6 h-full">
          ...
          <ScrollReveal delay={2}>
            <div className="rounded-xl border border-emerald-900/50 bg-emerald-950/10 p-6 h-full">
              <div className="flex items-center gap-2 mb-6">
        ...
        <ScrollReveal>
          <blockquote className="border-l-2 border-emerald-500 pl-6 max-w-3xl">
            ...
            <cite className="mt-3 block text-zinc-500 text-sm not-italic font-mono">&mdash; David Nielsen, Speclint (dogfooding our own product)</cite>
          </blockquote>
        </ScrollReveal>
      </div>
    </section>
