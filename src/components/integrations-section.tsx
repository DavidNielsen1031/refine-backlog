...
const integrations = [
  ...
  },
  {
    ...
    code: "npx speclint-mcp",
    href: "https://www.npmjs.com/package/speclint-mcp",
    cta: "npm →",
  },
  {
    icon: Terminal,
    ...
    code: "npx speclint-cli --file backlog.txt",
    href: "https://github.com/DavidNielsen1031/speclint-cli",
    cta: "GitHub →",
  },
]
