    ...
    <section className="bg-[#0a0a0a] py-24 border-b border-[#1a1a1a]">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {steps.map((step, i) => (
            <ScrollReveal key={step.number} delay={Math.min(i + 1, 4) as 1 | 2 | 3 | 4}>
              <div className="relative h-full">
                ...
                <div className="bg-[#0f0f0f] border border-[#1e1e1e] rounded-xl p-5 h-full card-hover hover:border-emerald-500/20">
                  ...
                  <pre className="bg-[#111] border border-[#222] rounded-lg px-3 py-2 text-[10px] text-emerald-300 font-mono overflow-x-auto leading-relaxed">
                    {step.code}
                  </pre>
                </div>
              </div>
        ...
        {/* Standalone rewrite API */}
        <ScrollReveal>
          <div className="bg-[#0f0f0f] border border-[#1e1e1e] border-l-2 border-l-emerald-500 rounded-xl p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <a
              href="#try-it"
              className="shrink-0 px-4 py-2 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-semibold text-xs rounded-lg hover:brightness-110 transition-all shadow-lg shadow-emerald-500/10"
            >
              Try it above {'\u2191'}
            </a>
          </div>
